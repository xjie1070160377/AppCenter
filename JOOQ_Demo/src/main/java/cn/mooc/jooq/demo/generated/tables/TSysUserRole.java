...
public class TSysUserRole extends TableImpl<TSysUserRoleRecord> {
    ...
    private static final long serialVersionUID = 1735650707;

    /**
     * The reference instance of <code>appcenter_mall_data.t_sys_user_role</code>
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user_role.id</code>.
     */
    public final TableField<TSysUserRoleRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>appcenter_mall_data.t_sys_user_role.userId</code>. 用户id
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user_role.roleId</code>. 角色id
     */
    ...
    /**
     * Create a <code>appcenter_mall_data.t_sys_user_role</code> table reference
     */
    public TSysUserRole() {
    ...
    /**
     * Create an aliased <code>appcenter_mall_data.t_sys_user_role</code> table reference
     */
     ...
     */
    @Override
    public List<ForeignKey<TSysUserRoleRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TSysUserRoleRecord, ?>>asList(Keys.FK_REFERENCE_S2);
    }
