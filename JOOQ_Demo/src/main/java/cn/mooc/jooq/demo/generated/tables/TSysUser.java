...
public class TSysUser extends TableImpl<TSysUserRecord> {
    ...
    private static final long serialVersionUID = 718883212;

    /**
     * The reference instance of <code>appcenter_mall_data.t_sys_user</code>
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.id</code>.
     */
    public final TableField<TSysUserRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>appcenter_mall_data.t_sys_user.userName</code>.
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.passWord</code>.
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.pwdSalt</code>.
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.status</code>. 0:禁用,1:启用
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.superUser</code>. 是否为超级用户
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.createTime</code>.
     */
    ...
    /**
     * The column <code>appcenter_mall_data.t_sys_user.lastUpdate</code>.
     */
    ...
    /**
     * Create a <code>appcenter_mall_data.t_sys_user</code> table reference
     */
    public TSysUser() {
    ...
    /**
     * Create an aliased <code>appcenter_mall_data.t_sys_user</code> table reference
     */
