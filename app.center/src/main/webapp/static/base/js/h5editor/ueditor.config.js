...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //, configUrl: BASEURL + "/static/base/js/h5editor/config.js"

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        
        , toolbars: [
        ["autostyle","bold","italic","underline","forecolor","shadowcolor","backcolor","|","justifyleft","justifycenter","justifyright",'justifyjustify', "indent","rowspacingtop",'rowspacingbottom',"lineheight","|","removeformat",'formatmatch','cleardoc',"paragraph","fontfamily","fontsize","inserttable",'background','attachment','simpleupload',"insertimage",'insertvideo', 'mp3',"horizontal","|","undo","redo","|",'spechars','emotion','link','superscript', 'subscript','insertorderedlist', 'insertunorderedlist','directionalityltr', 'directionalityrtl','searchreplace',"source", 'message']
        ]
...
//                'cn2':'(一),(二),(三)....',
        ...
        //lineheight
        //行内间距 值和显示的名字相同
        ,'lineheight':['1', '1.5','1.6','1.8','2', '3', '4', '5']
       ...
       //                "bold","italic","underline","forecolor","shadowcolor","insertorderedlist","insertunorderedlist","superscript", "subscript",
        ...
        //,codeMirrorJsUrl: "http://static.apiclub.cn/js/ueditor/third-party/codemirror/codemirror.js"
        //codeMirrorCssUrl css加载的路径，默认是 URL + "third-party/codemirror/codemirror.css"
        //,codeMirrorCssUrl: "http://static.apiclub.cn/js/ueditor/third-party/codemirror/codemirror.css"
        //编辑器初始化完成后是否进入源码模式，默认为否。
        //,sourceEditorFirst:false
        //,editorCssUrl:"http://static.apiclub.cn/js/ueditor/themes/default/css/ueditor.min.css"
        //编辑器初始化完成后是否进入源码模式，默认为否。
        //,sourceEditorFirst:false
