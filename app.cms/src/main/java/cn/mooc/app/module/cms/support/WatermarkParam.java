...
public class WatermarkParam {
	...
	public WatermarkParam(Boolean watermark, String imagePath, Integer alpha, Integer position, Integer paddingX, Integer paddingY, Integer minWidth, Integer minHeight) {
