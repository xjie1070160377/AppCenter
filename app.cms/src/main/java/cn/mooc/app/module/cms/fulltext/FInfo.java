...
public class FInfo extends EntityPathBase<Document> {
	...
	public final NumberPath<Integer> siteId = createNumber(SITE_ID,
			Integer.class);
	public final ArrayPath<Integer[],Integer> nodeId = createArray(NODE_ID,
			Integer[].class);
	public final ArrayPath<Integer[],Integer> userId = createArray(USER_ID,
			Integer[].class);
	public final ArrayPath<Integer[],Integer> attrId = createArray(ATTR_ID,
			Integer[].class);
