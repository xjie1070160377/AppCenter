 ...
 */
@Entity
@Table(name = "t_cms_workflow_process")
...
public abstract class WorkflowProcess implements java.io.Serializable {
	...
	@TableGenerator(name = "tg_t_cms_workflow_process", pkColumnValue = "t_cms_workflow_process", table = "t_id_table", pkColumnName = "table_name", valueColumnName = "id_value", initialValue = 1, allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "tg_t_cms_workflow_process")
	...
	@Column(name = "data_type", nullable = false, length = 50, insertable = false, updatable = false)
	...
	@Column(name = "is_rejection", nullable = false)
