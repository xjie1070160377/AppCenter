...
public class ValidatorUtil {
    ...
    public static boolean contains(final List<Long> array, final long valueToFind) {
        return ArrayUtils.contains(array.toArray(), valueToFind);
    }
	...
	public static boolean isMobile(String input) {
		return input.matches("^[1][3,4,5,7,8,9][0-9]{9}$");
	}
