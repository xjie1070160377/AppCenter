...
//        File file = new File(imgPath);  
        if (!logoFile.exists()) {  
            System.err.println(""+logoFile.getAbsolutePath()+"   该文件不存在！");  
            return;  
        }  
     ...
     * @throws Exception 
     */  
    public static BufferedImage encode(String content, File logoFile, boolean needCompress) throws Exception {  
        BufferedImage image = QRCodeUtil.createImage(content, logoFile,  
                needCompress);  
//        mkdirs(destPath);  
        return image;
...
//        ImageIO.write(image, FORMAT_NAME, new File(destPath+"/"+file));  
     ...
     * @throws Exception 
     */  
    public static BufferedImage encode(String content, File logoFile, String destPath)  
            throws Exception {  
        return QRCodeUtil.encode(content, logoFile, false);  
    }  
...
//        QRCodeUtil.encode(text, "d:/testQr/home_navIcon_7.jpg", "d:/testQr/", false);  
//        String result = QRCodeUtil.decode("d:/testQr/54564886.jpg");
//        System.out.println(result);
    	System.out.println(DateTimeUtil.dateFormat(new Date(), "yyMMddHHmmssSSS"));
    }  
}
