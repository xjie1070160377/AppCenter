 ...
 * 支持从模块的jar包中加载视图模板
 * 
 * 例如：app.cms的后台模板可以放在 app.cms.jar包中的 views 目录下，或 /WEB-INF/classpath 目录下，需配合 MWebCompositeResourceLoader 使用
 * 
 * 如果Jar包中没有对应的模板文件，则自动到站点模板的 RESOURCE.root 根目录 /WEB-INF/template/ 下找模板文件
 * 
 * 
 * @author Taven
 *
 */
public class WebClasspathResourceLoader extends ClasspathResourceLoader
{
	 ...
	 */
	public WebClasspathResourceLoader()
	{
	 ...
	 * @param classLoader
	 */
	public WebClasspathResourceLoader(ClassLoader classLoader)
	{
	 ...
	 */
	public WebClasspathResourceLoader(ClassLoader classLoader, String root)
	{
	 ...
	 * @param charset 
	 */
	public WebClasspathResourceLoader(ClassLoader classLoader, String root, String charset)
	{
	 ...
	 */
	public WebClasspathResourceLoader(String root)
	{
	...
	public WebClasspathResourceLoader(String root, String charset)
	{
